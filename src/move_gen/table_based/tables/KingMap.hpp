...
constexpr size_t KingMap::GetBoardIndex(const int color) { return Board::BitBoardsPerCol * color + kingIndex; }

constexpr uint64_t KingMap::GetMoves(const int msbInd) { return movesMap[msbInd]; }
